...
test.describe('AWS Integration Tests - Final Working Version', () => {
  ...
  test.describe('Page Structure', () => {
    test('should display main page elements', async ({ page }) => {
      ...
      // Check notes viewer section (use specific heading)
  ...
  test.describe('Authentication Form', () => {
    test('should display sign in form', async ({ page }) => {
      // Check sign in form elements with more specific selectors
  ...
  test.describe('Component Integration', () => {
    test('should have working refresh buttons', async ({ page }) => {
      // Check that refresh buttons are clickable
    ...
    test('should have working form inputs', async ({ page }) => {
      ...
      const usernameInput = page.locator('input[placeholder="Preferred Username"]');
